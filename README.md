~Im still working on this and there is a possibility of some files not being uploaded/the readme being stale or old/irrelevant data. I'll fix them the moment I reach a certain threshhold in terms of what Phonetic can do~
# Phonetic
